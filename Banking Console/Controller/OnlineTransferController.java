...
public class OnlineTransferController {
    ...
    public OnlineTransferController(TaxDebitController taxDebitControllerObj, TransactionUI transactionViewObj, TransactionDataGenerator receiptGeneratorObj, BankDataBase bankDataObj, InterestCalcController rateCalc) {
    ...
    public void initiateMoneyTransfer(Account senderAccount){
