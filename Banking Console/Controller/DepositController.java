...
public class DepositController {
    ...
    public DepositController (TaxDebitController taxDebitControllerObj, TransactionUI transactionViewObj, TransactionDataGenerator receiptGeneratorObj, BankDataBase bankDataBaseObj, InterestCalcController rateCalc) {
