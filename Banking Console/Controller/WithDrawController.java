...
public class WithDrawController  {
    ...
    public WithDrawController(TaxDebitController taxDebitControllerObj, TransactionUI transactionViewObj, TransactionDataGenerator receiptGeneratorObj, BankDataBase bankDataBaseObj, InterestCalcController rateCalc) {
