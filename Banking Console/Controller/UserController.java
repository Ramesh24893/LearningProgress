...
public class UserController {
    public static void showUserFeatures(BankDataBase bankDataObj, UserInputUI userInputUI, User userObject) {
        ...
        TaxCalcController rateCalc=new TaxCalcController();
        ...
        if (userObject.getAccount() == null) {
            ...
            while (flow) {
                TaxCalcController interestCalcObj = new TaxCalcController();
